...
import com.watniwat.android.myapplication.Course.CourseMemberFragment;
import com.watniwat.android.myapplication.Course.CourseMenuFragment;
...
public class CourseMenuFragmentAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            ...
            case 1: return new CourseMemberFragment();
